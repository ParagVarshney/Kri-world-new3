    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <motion.h3
          ...
          viewport={{ once: false }}
        >
          Get in Touch with TimeFar — We Value Your Connection
        </motion.h3>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-semibold text-gray-200 text-lg">Phone Number</p>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-semibold text-lg text-gray-200">Email Address</p>
                <p className="font-bold text-2xl text-white hover:text-[#00e5b4] transition-colors">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-semibold text-lg text-gray-200">Our Location</p>
